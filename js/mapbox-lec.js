...
// TODO TOGETHER: Change the color of the marker
    ...
    var markerAlamoOptions = {
        color: "#cf3a87",
        draggable: true
}

var markerAlamo = new mapboxgl.Marker (markerAlamoOptions)
    .setLngLat([-98.4861, 29.4260])
    .setPopup(new mapboxgl.Popup().setHTML("<h6>Remember The Alamo!</h6>"))
    .addTo(map);
...
// TODO TOGETHER: Comment out the popup we just added. Add a popup to the alamo marker.
    ...
    var markerCodeupOptions = {
        color: "#ebd334"
}

var markerCodeup = new mapboxgl.Marker(markerCodeupOptions)
    .setLngLat([-98.4896, 29.4268])
    .setPopup(new mapboxgl.Popup().setText("Codeup Rocks!"))
    .addTo(map);
