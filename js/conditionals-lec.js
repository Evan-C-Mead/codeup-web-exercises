...
// purchase(itemCost = 50,currentBalance = 50);
//
// function purchase(itemCost, currentBalance){
//     if(itemCost > currentBalance){
//         alert("Insufficient funds!")
//     } else {
//         alert("You may purchase this item.")
//     }
// }
...
//     alert("You are deleting everything!");
// } else {
...
// console.log(weatherAlert("raining"));
// console.log(weatherAlert("thunder storms"));
...
//     if(light === "green"){
//         return "Drive the speed limit.";
//     } else if(light === "yellow"){
//         return "Slow down and prepare to stop.";
//     } else if(light === "red"){
//         return "Slow down and stop.";
//     } else{
//         return "Not an option...";
//     }
// }
//
// console.log(drive("red"));
// console.log(drive("green"));
// console.log(drive("yellow"));
// console.log(drive("speed up"));
...
//         alert("You can get a license! Go you!");
//     } else if(userAge >= 16 && hasPermit === false){
//         alert("You need a permit before you get your license.")
//     } else {
//         alert("Call the help desk.");
//     }
// }
//
// console.log(17)
...
// var weatherMessage = "rainy";
// var weather = (weatherMessage) ? "It's raining!" : "Have a nice day!";
// console.log(weather)
